...
//		String accessKeyId = "LTAI4GEgZ4aY8E7RSLoJp3Eo"; 
//		String accessKeySecret = "54PObQCWpWCxZIjpWYEaXfoCNRfGso";
//		String title = "高林生 - 步步高.mp3";
//		String fileName = "C:\\Users\\Administrator\\Desktop\\高林生 - 步步高.mp3";
//		uploadVideo(accessKeyId, accessKeySecret, title, fileName);
	...
	public static void getPlayAuth() throws Exception {
		// 根据视频id获取视频播放地址
		DefaultAcsClient client = InitObject.initVodClient("LTAI4GEgZ4aY8E7RSLoJp3Eo", "54PObQCWpWCxZIjpWYEaXfoCNRfGso");

		GetVideoPlayAuthRequest request = new GetVideoPlayAuthRequest();
		GetVideoPlayAuthResponse response = new GetVideoPlayAuthResponse();
		
		request.setVideoId("8f3dcf6b8b4b40ec9aed376096552924");
	...
	public static void getPlayUrl() throws Exception {
		...
		// 设置视频id
		request.setVideoId("672980c7d8134824b379876ce858b881");
